...
public class GameController3 implements Initializable
{
    @FXML
    ...
    private int zombie_kill_left =6;
    private final int tot_zombies=6;
    ...
    public void initialize(URL location, ResourceBundle resources)
    {
        ...
        trans[0].setDuration(Duration.seconds(60));
        ...
        trans[1].setDuration(Duration.seconds(120));
        ...
        trans[4].setDuration(Duration.seconds(60));
        ...
        trans[8].setDuration(Duration.seconds(60));
        ...
        AnimationTimer at=new AnimationTimer() {
            ...
            public void handle(long now)
            {
                ...
                if((now-lastCheck[0])/1000000 >= 1) //Collisions Handling
                {
                    ...
                    {
                        win.setVisible(true);
                        Main.curUser.setLevelUnlocked( Main.curUser.getLevelUnlocked() + 1 );
                    }
